...
val managerVersionName = project.findProperty("CHUNIAN_VERSION_NAME")?.toString()
    ?: (rootProject.extra["managerVersionName"] as String)

val isPrBuild = project.findProperty("IS_PR_BUILD")?.toString()?.toBoolean() ?: false
val defaultManagerPackageName = if (isPrBuild) "me.weishu.chuniansu.pr" else "me.weishu.chuniansu"
val defaultManagerName = if (isPrBuild) "ChunianSU PR" else "ChunianSU"
